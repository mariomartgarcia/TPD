...
for ind in args.dataset:
    ...
    for k in ran:
        ...
        for h in range(cv):
            ...
            model.fit(pri, y_train, epochs=epo, batch_size=bs, verbose = 0)
            ...
            model.fit(X_train, y_train, epochs=epo, batch_size=bs, verbose = 0)
            ...
            model.fit(X_trainr, y_train, epochs=epo, batch_size=bs, verbose = 0)
            ...
            model.fit(X_trainr, yy_GD, epochs=epo, batch_size=bs, verbose = 0)
            ...
            model.fit(X_trainr, yy_PFD, epochs=epo, batch_size=bs, verbose = 0)
            ...
            model.fit(X_trainr, yy_TPD, epochs=epo, batch_size=bs, verbose = 0)
...
dff.to_csv('noval_' + v + '_'  + lc + '_' + str(drp) + '_' + str(epo) + '_' + str(bs)  + '_' +  str(imitation)  + '_' + str(regu) + '_' + str(l2regu) + '_' + str(n_iter)+ '.csv')
